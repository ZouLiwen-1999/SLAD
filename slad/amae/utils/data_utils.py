...
def get_loader(args):  
    ...
    jsonlist1 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/FLARE21/amae_dataset.json" #1000
    jsonlist2 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/CHETC/amae_dataset.json" #2534
    jsonlist3 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/NIH/amae_dataset.json" #82
    jsonlist4 =  "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/JHCM_Normal/amae_dataset.json" #394
    
    
    #数据集目录
    datadir1 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/FLARE21/"
    datadir2 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/CHETC/"
    datadir3 = "/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/NIH/"
    datadir4 ="/opt/data/private/work/SLAD/v4/data/pretraining/ROI100/JHCM_Normal/"
    

    num_workers = 16
    
    datalist1 = load_decathlon_datalist(jsonlist1, False, "training", base_dir=datadir1)
    print("Dataset 1 FLARE21: number of data: {}".format(len(datalist1)))
    new_datalist1 = []
    ...
    print("Dataset 2 CHETC: number of data: {}".format(len(datalist2)))
    new_datalist2 = []
    ...
    print("Dataset 3 NIH: number of data: {}".format(len(datalist3)))
    new_datalist3 = []
    ...
    print("Dataset 4 JHCM_Normal: number of data: {}".format(len(datalist4)))
    new_datalist4 = []
    ...
    datalist = new_datalist1 + new_datalist2 + new_datalist3 + new_datalist4 
    ...
    if args.cache_dataset:
        ...
        train_ds = PersistentDataset(data=datalist,
                                     ...
                                     cache_dir='/opt/data/private/code/nnseg/slad/amae/voco/cache')
...
class VoCoAugmentation():
    ...
    def __call__(self, x_in):
        ...
        imgs = [] #这是random crop，对应的labels在上面已经得到
