import nnunet
import slad
from slad.paths import network_training_output_dir,preprocessing_output_dir, default_plans_identifier
    
from batchgenerators.utilities.file_and_folder_operations import *
from nnunet.experiment_planning.summarize_plans import summarize_plans
from slad.training.model_restore import recursive_find_python_class
...
#                            "not require the cascade. Run 3d_fullres instead") #zlw注释
...
#     print("--------------------------------------------------")
    print("I am running the following architecture: %s" % network)
...
#     # output_folder_name = join(network_training_output_dir, network+'_'+plans_identifier, task, outname)
#     output_folder_name = join(network_training_output_dir, network, task, network_trainer + "__" + plans_identifier,outname)
