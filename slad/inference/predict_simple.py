...
import argparse
import torch
from slad.inference.predict import predict_from_folder
from slad.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
...
def main():
    ...
    parser.add_argument("-norm", type=str, default='BN', help='BN, IN or GN')
    parser.add_argument("-acti", type=str, default='LeakyReLU', help='LeakyReLU or ReLU')
