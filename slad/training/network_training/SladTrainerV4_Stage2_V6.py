...
import matplotlib
from slad.configuration import default_num_threads
...
from slad.network_architecture.nnDiffUNet import nnDiffUNet
from slad.paths import network_training_output_dir
from slad.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from nnunet.training.loss_functions.deep_supervision import MultipleOutputLoss2
from slad.training.network_training.SladTrainerV4_Stage1_V3 import SladTrainerV4_Stage1_V3
...
class SladTrainerV4_Stage2_V6(SladTrainerV4_Stage1_V3):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="SladTrainerV4_Stage1_V3", fp16=False):
        ...
        if self.output_folder is not None:
            ...
            folder_with_segs_prev_stage = join(network_training_output_dir, "3d_lowres",
                                               task, previous_trainer + "__" + plans_identifier, "pred_next_stage_fast") #zlw改为pred_next_stage_fast
    ...
    def initialize_network(self): #第二阶段的网络架构改为nnUNet, 嵌入CRGNet
        """
        - momentum 0.99
        - SGD instead of Adam
        ...
        self.num_input_channels=1 #zlw级联网络只提取图像特征
#         print('11111111', self.num_input_channels, self.num_classes)
        self.network = nnDiffUNet(in_channels=self.num_input_channels, out_channels=self.num_classes).cuda() 
