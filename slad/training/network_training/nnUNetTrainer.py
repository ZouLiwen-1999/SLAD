...
from slad.training.network_training.network_trainer import NetworkTrainer
...
#             self.print_to_log_file(self.network) #zlw不打印网络结构了
            self.print_to_log_file("pass\n")
        finally:
            if torch.cuda.is_available():
                torch.cuda.empty_cache()

    def run_training(self):
#         print('nnUNetTrainer.run_training()')
        dct = OrderedDict()
...
#         self.patch_size = np.array([64,128,128]).astype(int) #zlw手动改patch size
