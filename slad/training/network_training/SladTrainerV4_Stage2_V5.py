...
from slad.network_architecture.SLAD_stage2_v3 import SLAD_stage2_v3
...
class SladTrainerV4_Stage2_V5(SladTrainerV4_Stage1_V3):
    ...
    def initialize_network(self): #第二阶段的网络架构改为nnUNet, 嵌入CRGNet
        ...
        print('We are using the CGRM...')
        self.network = SLAD_stage2_v3( self.num_input_channels, self.base_num_features, self.num_classes,
