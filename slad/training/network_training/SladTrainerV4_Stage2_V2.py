...
from slad.network_architecture.SLAD_stage2 import SLAD_stage2
...
class SladTrainerV4_Stage2_V2(SladTrainerV4_Stage1_V3):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            self.network = SLAD_stage2( self.num_input_channels, self.base_num_features, self.num_classes,
